...
class Weibull(Base):
    ...
    def loglik(self,t,x,k=0.5,lmb=0.3,W=None,x_samples=None,x_censored=None):
        #
    ...
    def grad(self,t,x,k=0.5,lmb=0.3,W=None,x_samples=None,x_censored=None):
        #
        ...
        if W is not None and len(W.shape)==2 and x_samples is not None and x_censored is not None:
            ...
            for i in xrange(len(x_samples)):
                ...
                if pdf > 1e-8: # If the pdf is zero, we need to switch to survival.
